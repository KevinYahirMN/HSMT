...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_60.php">
					<!--section 59-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Me gustan las sugerencias de las personas que admiro.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me gusta tener a mi cargo a otras personas.</B></label>
					<hr>
