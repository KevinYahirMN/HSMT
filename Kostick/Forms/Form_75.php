...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_76.php">
					<!--section 75-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Soy activo y con mucho vigor.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Dedico mucho tiempo a pensar.</B></label>
					<hr>
