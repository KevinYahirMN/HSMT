	...
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_16.php">
					...
					<label><B>A) Me gusta identificarme con grupos. </B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me gusta ayudar a las personas a que tomen una conclusión.</B></label>
					<hr>
