...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_77.php">
					<!--section 76-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Soy cordial con la gente.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me gusta el trabajo que requiere precisión.</B></label>
					<hr>
