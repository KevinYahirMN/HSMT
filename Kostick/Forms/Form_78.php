...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_79.php">
					<!--section 78-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Me gusta el trabajo que requiere detalles.  </B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Siempre termino el trabajo que he empezado.</B></label>
					<hr>
