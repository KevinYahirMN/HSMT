...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_73.php">
					<!--section 72-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) El grupo hace normalmente lo que yo quiero.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Normalmente tengo prisa.</B></label>
					<hr>
