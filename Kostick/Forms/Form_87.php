...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_88.php">
					<!--section 87-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Me gusta trabajar con problemas teóricos.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me gusta trabajar con detalles.</B></label>
					<hr>
