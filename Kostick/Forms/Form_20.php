	...
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_21.php">
					...
					<label><B>A) Me gusta que me den instrucciones precisas para hacer un trabajo.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me gustaría decírselo a la gente cuando me molestan.</B></label>
					<hr>
