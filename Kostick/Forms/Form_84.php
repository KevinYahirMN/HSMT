...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_85.php">
					<!--section 84-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Normalmente trabajo de prisa. </B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Hago ejercicio con regularidad.</B></label>
					<hr>
