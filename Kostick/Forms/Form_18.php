	...
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_19.php">
					...
					<label><B>A) Algunas veces culpo a otros cuando las cosas salen mal.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me molesta cuando le soy antipático a alguien.</B></label>
					<hr>
