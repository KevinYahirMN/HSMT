...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_59.php">
					<!--section 58-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Normalmente sostengo mis creencias.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Normalmente me gusta trabajar intensamente.</B></label>
					<hr>
