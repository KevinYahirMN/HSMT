...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_61.php">
					<!--section 60-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Me dejo influenciar fácilmente por otras personas.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me gusta que me pongan mucha atención.</B></label>
					<hr>
