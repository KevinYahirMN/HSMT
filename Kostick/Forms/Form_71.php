...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_72.php">
					<!--section 71-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Siempre me esfuerzo mucho.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Tomo decisiones fácil y rápidamente.</B></label>
					<hr>
