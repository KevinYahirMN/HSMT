...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_55.php">
					<!--section 54-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Trabajo a un paso rápido y constante.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Disfruto trabajando con detalles.</B></label>
					<hr>
