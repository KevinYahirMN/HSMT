	...
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_28.php">
					...
					<label><B>A) Me gusta hacer cosas nuevas y diferentes.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me gusta hablar de la forma como obtengo mis éxitos.</B></label>
					<hr>
