...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_58.php">
					<!--section 57-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Quiero conocer nueva gente y hacer cosas nuevas.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Siempre quiero terminar el trabajo que he empezado.</B></label>
					<hr>
