...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_71.php">
					<!--section 70-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Me gusta que otros tomen decisiones para el grupo.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) A mi me gusta tomar decisiones para el grupo.</B></label>
					<hr>
