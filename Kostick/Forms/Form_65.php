	...
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_66.php">
					...
					<label><B>A) Me gusta el trabajo en donde puedo moverme.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me gusta el trabajo que tiene que hacerse con cuidado.</B></label>
					<hr>
