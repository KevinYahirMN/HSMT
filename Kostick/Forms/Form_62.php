...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_63.php">
					<!--section 62-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Cuando hablo, el grupo escucha.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Soy hábil con herramientas.</B></label>
					<hr>
