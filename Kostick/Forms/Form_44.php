...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_45.php">
					<!--section 44-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) La gente piensa que trabajo con rapidez.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) La gente piensa que tengo mis cosas limpias y ordenadas.</B></label>
					<hr>
