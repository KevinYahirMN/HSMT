...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_69.php">
					<!--section 68-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Yo cuido mucho mi reputación.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Yo le pongo atención a un problema hasta que se resuelve.</B></label>
					<hr>
