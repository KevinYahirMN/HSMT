...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_83.php">
					<!--section 82-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Hago que los demás trabajen intensamente.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Soy una persona que no se preocupa por nada.</B></label>
					<hr>
