	...
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_25.php">
					...
					<label><B>A) Me gusta trabajar en varias actividades al mismo tiempo.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Cuando estoy en un grupo, me gusta estar callado.</B></label>
					<hr>
