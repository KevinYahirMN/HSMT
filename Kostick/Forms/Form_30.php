...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_31.php">
					<!--section 30-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Me gusta que me digan exactamente como hacer mi trabajo.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me aburro fácilmente.</B></label>
					<hr>
