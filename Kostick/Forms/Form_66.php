...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_67.php">
					<!--section 66-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Hago el mayor número posible de amigos.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Encuentro lo que me he guardado.</B></label>
					<hr>
