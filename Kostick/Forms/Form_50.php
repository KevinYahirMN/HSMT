...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_51.php">
					<!--section 50-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Me gusta tener instrucciones precisas para hacer un trabajo.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me gusta estar con la gente.</B></label>
					<hr>
