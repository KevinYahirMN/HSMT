...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_40.php">
					<!--section 39-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Me gusta agradar a mis superiores.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Estoy interesado en ser parte del grupo.</B></label>
					<hr>
