...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_43.php">
					<!--section 42-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) La gente piensa que soy un buen "dirigente".</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Pienso las cosas con cuidado y detenidamente.</B></label>
					<hr>
