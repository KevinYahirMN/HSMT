...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_34.php">
					<!--section 33-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Tomo decisiones fácil y rápidamente.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Tengo mis cosas limpias y ordenadas.</B></label>
					<hr>
