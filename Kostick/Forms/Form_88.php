...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_89.php">
					<!--section 88-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Me gusta trabajar con detalles.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me gusta organizar mi trabajo.</B></label>
					<hr>
