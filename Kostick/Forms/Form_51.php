...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_52.php">
					<!--section 51-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Siempre trato de hacer mi trabajo perfecto.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Me dicen que soy prácticamente incanzable.</B></label>
					<hr>
