...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_57.php">
					<!--section 56-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Me llevo bien con todo el mundo.</B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Soy de temperamento estable.</B></label>
					<hr>
