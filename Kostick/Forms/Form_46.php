...
<body>
	<div class="container">
		...
		<div class="card">
			...
			<form method="post" action="Form_47.php">
					<!--section 46-->            
					<input type="radio" value="A" name="Q" onclick="enable()">
					<label><B>A) Me gusta que la gente sea unida y sea amistosa. </B></label><br>
					<input type="radio" value="B" name="Q" onclick="enable()">
					<label><B>B) Siempre trato de terminar un trabajo difícil.</B></label>
					<hr>
