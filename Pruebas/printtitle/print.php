...
class aditionalInterpretation{
    ...
    function three(){
        ...
        las siguientes características: Preocupados por su 
    ...
    function four(){
        $text = 'Esta combinación es más frecuente en 
        mujeres. Las características principales son las 
        siguientes: Síntomas pertenecientes a la histeria de 
    ...
    function twofive(){
        ...
        (es más frecuente en mujeres que en hombres): Ansiedad 
    ...
    function onenine(){
        $text = 'Represión de hostilidad manifestada con estados 
    ...
    function fournine(){
        $text = 'Inmadurez, narcisismo, dependencia, 
    ...
    function twoeleven(){
        $text = 'Narcisismo y egocentrismo. 
    ...
    function threeeleven(){
        ...
        a este perfil son las siguientes: Ansiedad, temor, 
