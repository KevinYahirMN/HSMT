...
class basicScales{
   ...
   function scale_Dp($answer = array()){
      ...
      $this->calif_False($answer[34]);
      $this->calif_True($answer[35]);
      $this->calif_True($answer[42]);
