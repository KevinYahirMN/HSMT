...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_70.php">

			       
					<!--Pregunta 69-->
					<p>En un idioma extranjero, BECO PRAC quiere decir un poco de pan.

KLUP PRAC            -          -   Un poco de leche

BECO OTOH KLUP PRAC -             - Un poco de pan y leche.
