...
class count{
    ...
    function calif_Five($answer = 0){
        if($answer == 5){
            return 1;
        }
    }

    //Sumatoria de respuesta 7
    function calif_Seven($answer = 0){
        if($answer == 7){
            return 1;
        }
    }

    //Sumatoria de respuesta 8
    function calif_Eight($answer = 0){
        if($answer == 8){
            return 1;
        }
    }

    //Sumatoria de respuesta 10
    function calif_Ten($answer = 0){
        if($answer == 10){
            return 1;
        }
    }

    //Sumatoria de respuesta 13
    function calif_Thirteen($answer = 0){
        if($answer == 13){
            return 1;
        }
    }

    //Sumatoria de respuesta 16
    function calif_Sixteen($answer = 0){
        if($answer == 16){
            return 1;
        }
    }
    ...
    function calif_Seventeen($answer = 0){
        if($answer == 17){
            return 1;
        }
    }
