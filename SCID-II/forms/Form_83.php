...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_84.php">

			       
					<!--Pregunta 83-->
					<p>¿Siente usted que es una persona con talento o habilidades especiales que los demás no han reconocido?</p>  
