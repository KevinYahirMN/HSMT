	...
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_30.php">
					...
					<!--Pregunta 29-->
					<p>Algunas personas trabajan lentamente en forma deliberada o hacen mal las cosas cuando se les pide que hagan algo que realmente no quieren hacer, ¿es usted así?</p>  
