...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_68.php">

			       
					<!--Pregunta 67-->
					<p>Algunas personas parecen no sentir nunca emociones fuertes, como un gran enojo o gran felicidad, ¿es usted así?</p>  
