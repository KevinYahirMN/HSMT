	...
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_6.php">
					...
					<!--Pregunta 5-->
					<p>¿Cuándo asiste a reuniones o eventos sociales, generalmente prefiere guardar silencio por temor a decir algo incorrecto, o a no contestar alguna pregunta?</p>  
