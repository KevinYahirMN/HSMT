...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_80.php">

			       
					<!--Pregunta 79-->
					<p>Algunas personas pueden aguantar mucho cuando saben que finalmente obtendrán algo que desean, otras pueden esperar a obtener lo que quieren, ¿es usted el tipo de persona que no puede esperar?</p>  
