...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_86.php">

			       
					<!--Pregunta 85-->
					<p>¿Diría usted que los problemas a los que se enfrenta son tan especiales que pocas personas podrían entenderlas?</p>  
