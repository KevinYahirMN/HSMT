...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_38.php">

			       
					<!--Pregunta 37-->
					<p>¿Se mete con frecuencia en situaciones difíciles en el trabajo o en la escuela de las que sale desilusionado o lastimado?</p>  
