...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_35.php">

			       
					<!--Pregunta 34-->
					<p>¿Se ha quejado la gente alguna vez de que usted los obstaculice al no hacer la parte que le corresponde de su trabajo?</p>  
