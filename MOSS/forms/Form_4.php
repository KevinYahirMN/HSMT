...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_5.php">

			       
					
					<!--Pregunta 4-->
					<p>Uno de los socios, sin autoridad sobre usted le ordena haga algo en forma bien
                       distinta de lo que planeaba. ¿Qué haría usted?</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Acatar la orden y no armar mayor revuelo</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Ignorar las indicaciones y hacerlo según había planeado.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Decirle que esto no es asunto que a él le interese y que usted hará las cosas a su modo.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Decirle que lo haga él mismo.</label>
					<hr>
