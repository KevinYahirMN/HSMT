...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_30.php">

			       
					<!--Pregunta 29-->
					<p>Un compañero flojea de tal manera que a usted le toca más de lo que le
						corresponde. La mejor forma de conservar las relaciones sería:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Explicar el caso al jefe cortésmente.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Cortésmente indicarle que debe hacer lo que le corresponde o que usted se quejará con el jefe.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Hacer tanto como pueda eficientemente y no decir nada del caso al jefe.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Hacer lo suyo y dejar pendiente lo que el compañero no haga.</label>
					<hr>
