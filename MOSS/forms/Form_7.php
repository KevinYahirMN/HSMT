...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_8.php">
					...
					<label>B) Se sienta inquieto por la rutina de la oficina.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Busque otro trabajo.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Resulte muy ineficiente en el trabajo de oficina.</label>
					<hr>
