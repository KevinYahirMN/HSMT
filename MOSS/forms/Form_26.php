...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_27.php">

			       
					<!--Pregunta 26-->
					<p>Zaldívar es eficiente, pero de esos que "todo lo saben", critica a Montoya y el jefe opina que la idea de Montoya ahorra tiempo. 
						Probablemente Zaldivar:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Pida otro trabajo al jefe.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Lo haga a su modo sin comentarios.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Lo haga con Montoya, pero siga criticándolo.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Lo haga con Montoya, pero mal a propósito.</label>
					<hr>
