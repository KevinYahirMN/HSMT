	...
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_17.php">
					...
					<!--Pregunta 16-->
					<p>Una persona recién ascendida a un mejor puesto de autoridad lograría mejor
						metas y la buena voluntad de los empleados...:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Tratando de que cada empleado entienda qué es la verdadera eficiencia.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Ascendiendo cuanto antes a quienes considere lo merezcan.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Preguntando confidencialmente a cada empleado en cuanto a los cambios que estiman necesarios.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Seguir los sistemas del anterior jefe y gradualmente hacer los cambios necesarios.</label>
					<hr>
