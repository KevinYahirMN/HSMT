	...
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_3.php">
					...
					<!--Pregunta 2-->
					<p>Tiene usted un empleado muy eficiente pero que constantemente se queja del
					trabajo, sus quejas producen mal efecto en los demás empleados, lo mejor sería:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Pedir a los demás empleados que no hagan caso. </label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Averiguar la causa de esa actitud y procurar su modificación.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Cambiarlo de departamento donde quede a cargo de otro jefe.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Permitirle planear lo más posible acerca de su trabajo.</label>
					<hr>
