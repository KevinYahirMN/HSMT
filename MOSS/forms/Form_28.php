...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_29.php">

			       
					<!--Pregunta 28-->
					<p>Es usted un joven que encuentra en la calle a una mujer de más edad a quien
						apenas conoce y que parece haber estado llorando. Lo mejor sería:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Preguntarle por qué está triste.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Pasarle el brazo consoladoramente.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Simular no advertir su pena.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Simular no haberla visto.</label>
					<hr>
