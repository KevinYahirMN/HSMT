...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_12.php">

			       
					<!--Pregunta 11-->
					<p>Es usted un joven empleado que va a comer con una maestra a quien conoce
					   superficialmente. Lo mejor seria iniciar la conversación acerca de:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Algún tópico de actualidad.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Algún aspecto interesante de su propio trabajo.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Las tendencias actuales en el terreno docente.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Las sociedades de padres de familia.</label>
					<hr>
