...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_25.php">

			       
					<!--Pregunta 24-->
					<p> Es usted un maestro de primaria. Camino a la escuela tras la primera nevada,
						algunos de sus alumnos lanzan bolas de nieve. Desde el punto de vista de la buena
						administración de la escolar, usted debería: </p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Castigarles ahí mismo por su indisciplina.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Decirles que de volverlo a hacer los castigará.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Pasar la queja a sus padres.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Tomarlo como broma y no hacer caso al respecto.</label>
					<hr>
