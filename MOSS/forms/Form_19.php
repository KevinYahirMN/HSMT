...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_20.php">

			       
					<!--Pregunta 19-->
					<p>El señor González ha estado conservando su puesto subordinado por 10 años, desempeña su trabajo callado y confidencialmente y se le extrañará cuando se vaya.
						De obtener el trabajo en otra empresa, muy probablemente:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Asuma fácilmente responsabilidad como supervisor.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Haga ver de inmediato su valor.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Sea lento para abrirse las necesarias oportunidades.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Renuncie ante la más ligera crítica de su trabajo.</label>
					<hr>
