...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_10.php">

			       
					<!--Pregunta 9-->
					<p>Un joven invita a una dama al teatro, al llegar se percata de que ha olvidado la cartera. Sería mejor:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Tratar de obtener boletos dejando el reloj en prenda.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Buscar a algún amigo a quien pedir prestado.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Decidir de acuerdo con ella lo procedente.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Dar una excusa plausible para ir a casa por dinero.</label>
					<hr>
