...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_24.php">

			       
					<!--Pregunta 23-->
					<p>Es usted un empleado ordinario en una oficina grande. 
						El jefe entra cuando usted lee en vez de trabajar. Lo mejor sería:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Doblar el periódico y volver a trabajo.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Pretender que obtiene recortes necesarios al trabajo.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Tratar de interesar al jefe leyéndole un encabezado importante.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Seguir leyendo sin mostrar embarazo.</label>
					<hr>
