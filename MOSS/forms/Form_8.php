...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_9.php">

			       
					
					<!--Pregunta 8-->
					<p>Tiene dos invitados a cenar: uno radical y el otro conservador. 
                       Surge una acalorada discusión respecto a la política. Lo mejor sería:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Tomar partido.</label><br>
