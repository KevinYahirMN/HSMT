...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_16.php">

			       
					<!--Pregunta 15-->
					<p>Tras haber hecho un buen número de favores a un amigo, este empieza a dar por
						sentado que usted será quien le resuelva todas sus pequeñas dificultades. 
						La mejor forma de readaptar la situación sin ofenderle sería:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Explicar el daño que se está causando.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Pedir a un amigo mutuo que trate de arreglar las cosas.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Ayudarle una vez más pero de tal manera que sienta que mejor hubiera sido no haberlo solicitado.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Darle una excusa para no seguir ayudándole.</label>
					<hr>
