...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_19.php">

			       
					<!--Pregunta 18-->
					<p>Es usted un ejecutivo y dos de sus empleados se llevan mal, pero ambos son eficientes. 
						Lo mejor sería:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Despedir al menos eficiente.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Dar trabajo en común que a ambos interese.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Hacerles ver el daño que se hacen.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Darles trabajos distintos.</label>
					<hr>
