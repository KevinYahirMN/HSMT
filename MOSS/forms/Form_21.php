	...
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_22.php">
					...
					<!--Pregunta 21-->
					<p>En igualdad de circunstancias el empleado que mejor se adapta a un nuevo puesto
						es aquel que:</p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Ha sido bueno en puestos anteriores.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Ha tenido éxito durante 10 años en su puesto.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Tiene sus propias ideas e invariablemente se rige por ellas.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Cuenta con una buena recomendación de su jefe anterior.</label>
					<hr>
