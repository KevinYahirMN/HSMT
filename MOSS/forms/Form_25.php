...
<body>
	<div class="container">
		...
		<div class="card">
            ...
            <form method="post" action="Form_26.php">

			       
					<!--Pregunta 25-->
					<p>Preside el Comité de Mejoras Materiales en su colonia; las últimas reuniones han
						sido de escasa asistencia. Se mejoraría la asistencia: </p>  
					<input type="radio" value="a" name="Q" onclick="enable()">
					<label>A) Visitando vecinos prominentes explicándoles los problemas.</label><br>
					<input type="radio" value="b" name="Q" onclick="enable()">
					<label>B) Avisar de un programa interesante para la reunión.</label><br>
					<input type="radio" value="c" name="Q" onclick="enable()">
					<label>C) Poner avisos en los lugares públicos.</label><br>
					<input type="radio" value="d" name="Q" onclick="enable()">
					<label>D) Enviar avisos personales.</label>
					<hr>
